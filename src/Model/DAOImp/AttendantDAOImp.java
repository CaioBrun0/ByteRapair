...
import Model.DAOInter.AttendantDAO;
...
import static Model.Entities.Client.listOS;
...
public class AttendantDAOImp implements AttendantDAO {
    Model.DAOImp.ClientDAOImp c1 = new Model.DAOImp.ClientDAOImp();
    Model.DAOImp.OSDAOImp os1 = new Model.DAOImp.OSDAOImp();
        ...
        switch (type) {
            case 1:
                for (OS os : listOS) {
                    ...
                    Model.DAOImp.InvoiceDAOImp invo = new Model.DAOImp.InvoiceDAOImp();
